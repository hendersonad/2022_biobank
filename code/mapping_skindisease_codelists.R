...
eczema_mapped_v2tov3 <- medcodes_eczema_dx %>% 
  ...
  #dplyr::select(readcode, original_desc = desc, chapter, readv2_desc, termv2_type, readv3_Code, termv3_code, termv3_desc, termv3_type)
  mutate(match_mark = 1)
